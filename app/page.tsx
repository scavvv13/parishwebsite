...
export default function Home() {
  return (
    <div className=" flex flex-col lg:flex-row lg:justify-between px-2 lg:px-14 py-8 ">
      ...
      <div className="w-full lg:w-1/2 pt-[80px] lg:pt-0">
        <strong className=" playfair text-[30px] lg:text-[72px] font-normal">
          Mass Schedule
        </strong>
        <Clock />
        {/* div for the two buttons */}
        <div className="flex justify-end gap-4 font-semibold text-md">
          <button
            title="Stream Online"
